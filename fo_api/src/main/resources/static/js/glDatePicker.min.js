...
y=y(0,6,b.selectableDOW),z=b.dowNames||"日 一 二 三 四 五 六".split(" "),t=b.monthNames||"1月 2月 3月 4月 5月 6月 7月 8月 9月 10月 11月 12月".split(" "),f=d.outerWidth(),e,k=f/7+6*(b.borderSize/7),f=f/8+7*(b.borderSize/8);c.length?eval(c.data("is"))||(f=c.outerWidth(),e=c.outerHeight(),k=f/7+6*(b.borderSize/7),f=e/8+7*(b.borderSize/8)):(g.calendar=c=$("<div/>").attr("gldp-el",d.attr("gldp-id")).data("is",!0).css({display:b.showAlways?void 0:"none",zIndex:b.zIndex,
